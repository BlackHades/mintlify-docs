...
import { Card, CardGroup, Icon } from '@mintlify/components';
...
<img
  ...
  alt="Payfonte - Africa Payment Orchestration Platform | Mobile Money API Integration"
/>
<img
...
**Payfonte** is Africa's leading **payment orchestration platform** and **mobile money payment aggregator** that enables businesses to accept and disburse payments across **14+ African markets** through a single, unified **payment orchestration API**. 
...
<CardGroup cols={4}>
  ...
  <Card title="$100M+ TPV" icon="chart-line">
    Processed transactions
  </Card>
  <Card title="99.99% Uptime" icon="shield-check">
    Enterprise reliability
  </Card>
  <Card title="T+1-3 Settlement" icon="clock">
...
<CardGroup cols={2}>
  <Card 
    title="Payment Orchestration / Infrastructure-as-a-Service" 
    icon="server"
    href="/guides/introductions/products#payment-orchestration"
  >
  ...
  <Card 
    ...
    icon="layer-group"
    href="/guides/introductions/products#payment-aggregation"
  >
...
<CardGroup cols={2}>
  ...
  <Card title="Provider Details" icon="info" href="/guides/introductions/provider-details">
    Decimal places, limits, and technical specifications for each **mobile money API**
  </Card>
</CardGroup>
