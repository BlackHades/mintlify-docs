...
<AccordionGroup>
  ...
  <Accordion title="Can I send disbursements (disbursements)?" icon="paper-plane">
    ...
    **Typical processing times:**
    ...
    See our [Disbursements Guide](/guides/disbursements/overview) for full documentation.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="How should I format amounts?" icon="hashtag">
    Amount formatting depends on the currency and provider in your **mobile money API** integration:

    **Decimal places by currency:**

    | Currency | Decimals | Example | Meaning |
    |----------|----------|---------|---------|
    | **NGN** (Naira) | 2 places | `5000.50` | ₦5,000.50 |
    | **KES** (Shilling) | Varies* | `1000` | KSh 1,000 |
    | **GHS** (Cedi) | 2 places | `100.00` | GH₵100.00 |
    | **XOF** (CFA Franc) | No decimals | `10000` | 10,000 XOF |
    | **XAF** (CFA Franc) | No decimals | `5000` | 5,000 XAF |

    *Kenya M-Pesa: Deposits don't support decimals; disbursements support 2 places.

    <Warning>
      **Important**: Sending decimals to providers that don't support them will cause transaction failures. Always check our [Provider Details](/guides/introductions/provider-details) page for the correct format.
    </Warning>

    See [Provider Details](/guides/introductions/provider-details) for complete decimal specifications per provider.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="How do I test different transaction scenarios in sandbox?" icon="flask-vial">
    ...
    See our [Testing Guide](/guides/introductions/testing) for complete test scenarios.
  </Accordion>
</AccordionGroup>
