...
<Frame>
  <img
    src="/images/api-keys-location.png"
    alt="API Keys Location in Dashboard"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card
    title="Explore Collection Methods"
    icon="credit-card"
    href="/en/guides/collections/overview"
  >
    Learn about inline, standard, and direct charge integrations
  </Card>
  <Card
    title="Set Up Disbursements"
    icon="money-bill-transfer"
    href="/en/guides/disbursements/overview"
  >
