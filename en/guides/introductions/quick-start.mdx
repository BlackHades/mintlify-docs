...
<AccordionGroup>
  ...
  <Accordion title="Invalid Country/Currency Combination">
    Make sure the currency matches the country. For example, Nigeria uses NGN, Kenya uses KES. See [Supported Providers](/en/guides/introductions/supported-providers) for valid combinations.
  </Accordion>
