...
2. Once you get to the setting screen you should get following below, you can get your API keys by following the steps in [Authorization](/en/guides/introductions/authorization)
3.
