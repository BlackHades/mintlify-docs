...
<CardGroup cols={2}>
  ...
  <Card title="Direct Charge" icon="bolt" href="/en/guides/collections/direct-charge-api">
    **Server-to-Server**
...
See [Supported Providers](/en/guides/introductions/supported-providers) for the complete list of **local payment methods in Africa**.
...
| `amount` | integer | Payment amount in minor units (see [Amount Specification](/en/guides/introductions/amount-specification)) |
...
See [Webhooks](/en/guides/collections/webhook) for complete documentation.
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook Setup" icon="bell" href="/en/guides/collections/webhook">
    Handle payment notifications
  </Card>
  <Card title="API Reference" icon="code" href="/en/api-reference/collections/collection-api--direct">
