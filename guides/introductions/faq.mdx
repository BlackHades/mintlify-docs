...
<AccordionGroup>
  <Accordion title="How should I format amounts?" icon="hashtag">
    ...
    See [Amount Specification](/guides/introductions/amount-specification) for full conversion guidance, and [Supported Providers](/guides/introductions/supported-providers) for provider limits.
  </Accordion>
