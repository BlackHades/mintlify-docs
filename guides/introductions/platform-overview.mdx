...
<AccordionGroup>
  <Accordion title="Start with the Dashboard" icon="rocket" defaultOpen>
    The dashboard is the fastest way to begin. You can create your account, configure payment or disbursement providers, set webhook URLs, and invite teammates with roles and permissions.
