...
description: "Copy-ready direct charge payloads for standard mobile money, Pawapay, and Orange pre-OTP provider flows."
icon: "code"
---
...
| `customerInput.network` | string | Provider-specific | Required for Pawapay flows |
...
<AccordionGroup>
  ...
  <Accordion title="Provider slug" icon="tag">
    Ensure `provider` matches a valid slug from [Supported Providers](/guides/introductions/supported-providers).
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Mobile Money Flows" icon="mobile-screen-button" href="/guides/collections/direct-charge/mobile-money">
