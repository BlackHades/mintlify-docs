...
- `Optional` From your infrastructure/application, call our [Fetch Provider Payment Properties](https://docs.payfonte.com/api/#get-/payments/v1/payments/direct-charge/-properties-) to get the additional the for the API call.
...
the [Supported Providers](/collections/direct-charge/supported-providers.md) Section.
...
| `customerInput` | Object                 | This is an object of inputs to be passed to the provider. This varies per provider. You can find more in the [Examples](/collections/direct-charge/examples.md) Section. | True     |
...
our [Direct Charge API](https://docs.payfonte.com/api/#post-/payments/v1/payments/direct-charge) API and provide the
