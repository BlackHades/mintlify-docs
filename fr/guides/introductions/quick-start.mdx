...
<Frame>
  <img
    ...
    alt="Emplacement des clés API dans le dashboard"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card
    title="Explorer les méthodes de collecte"
    icon="credit-card"
    href="/fr/guides/collections/overview"
  >
    Découvrez les intégrations inline, standard et direct charge
  </Card>
  <Card
    title="Configurer les décaissements"
    icon="money-bill-transfer"
    href="/fr/guides/disbursements/overview"
  >
